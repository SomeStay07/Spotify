...
final class APICaller {
    ...
    public func getNewReleases(completion: @escaping ((Result<NewReleasesResponse, Error>) -> Void)) {
        createRequest(
            with: URL(
                string: Constants.baseAPIURL + "/browse/new-releases?limit=50"),
            type: .GET,
    ...
    public func getRecommendations(
        genres: Set<String>,
        completion: @escaping (Result<RecommendationsResponse, Error>
        ) -> Void
    ) {
    ...
    // MARK: - CategoriyPlaylist
    public func getCategoriyPlaylist(category: Category, completion: @escaping (Result<[Playlist], Error>) -> Void) {
        createRequest(
